    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      ...
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        <h2
          ...
          className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#8B0000] to-[#FF4444]"
        >
          <span
            style={{
              color: "#8B0000",
              backgroundImage:
                "linear-gradient(45deg, #8B0000 10%, #FF4444 93%)",
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
          ...
          <div
            ...
            className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-500 hover:shadow-[#8B0000]/10"
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-4xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-[#8B0000] to-[#FF4444]">
                  Hubungi
                </h2>
              ...
              <Share2 className="w-10 h-10 text-[#8B0000] opacity-50" />
            </div>
            ...
            >
              ...
              >
                <User className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#8B0000] transition-colors" />
                <input
                  type="text"
                  name="name"
              ...
              <div
                ...
                className="relative group"
              >
                <Mail className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#8B0000] transition-colors" />
                <input
                  type="email"
                  name="email"
              ...
              <div
                ...
                className="relative group"
              >
                <MessageSquare className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#8B0000] transition-colors" />
                <textarea
                  name="message"
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#8B0000]/30 transition-all duration-300 hover:border-[#8B0000]/30 h-[9.9rem] disabled:opacity-50"
                  required
                />
              </div>
              <button
          ...
          {/* --- Komponen Komentar --- */}
          <div className="  bg-white/5 backdrop-blur-xl rounded-3xl p-3 py-3 md:p-10 md:py-8 shadow-2xl transform transition-all duration-500 hover:shadow-[#8B0000]/10">
